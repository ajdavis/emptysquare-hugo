...
{{% pic src="IMG_6363.jpg" alt="A street scene in Kathmandu" %}}
Kathmandu.
{{% /pic %}}

<video controls style="width: 100%; margin-bottom: 0.5em">
  <source src="IMG_6365.mp4" type="video/mp4">
</video>
<div style="text-align: center; margin-bottom: 1em; font-size: 18px"><em>One of the greatest Buddhist stupas on Earth, infested with repulsive monkeys.</em></div>

{{% pic src="IMG_6368.jpg" alt="A monkey at Swayambhunath" %}}
A Swayambhunath monkey---aggressive and uncouth.
{{% /pic %}}

<video controls style="width: 100%; margin-bottom: 1em">
  <source src="IMG_6373.mp4" type="video/mp4">
</video>
...
{{% pic src="IMG_6374.jpg" alt="Ratnakar Mahavihar in Patan" %}}
Ratnakar Mahavihar.
{{% /pic %}}

{{% pic src="IMG_6383.jpg" alt="Newari sculpture in Patan Durbar Square" %}}
Sculpture in a terrific museum of Newari architecture in Patan Durbar Square.
{{% /pic %}}

{{% pic src="IMG_6393.jpg" alt="A faceless deity in the Patan Durbar Square museum" %}}
A faceless deity in the museum. I didn't record what the label said.
{{% /pic %}}

{{% pic src="IMG_6402.jpg" alt="Narada, the Heavenly Musician" %}}
...
<video controls style="width: 100%; margin-bottom: 0.5em">
  <source src="IMG_6451.mp4" type="video/mp4">
</video>
...
<video controls style="width: 100%; margin-bottom: 0.5em">
  <source src="IMG_6427.mp4" type="video/mp4">
</video>
<div style="text-align: center; margin-bottom: 1em; font-size: 18px"><em>Pashupatinath ghat.</em></div>

{{% pic src="IMG_6436.jpg" alt="Shrines with lingams at Pashupatinath" %}}
...
{{% pic src="map-ulleri-ghorepani.png" alt="Map of the trek from Ulleri to Ghorepani" %}}
Ulleri to Ghorepani. 5.2 miles, 3,150 ft up, 200 ft down, 3h 24m.
{{% /pic %}}

{{% pic src="IMG_6472.jpg" alt="A rooster on the trail" %}}
...
{{% pic src="IMG_6505.jpg" alt="My thigh with a big bloody Band-Aid" %}}
...
{{% pic src="IMG_6502.jpg" alt="Wet trekking gear drying around a wood stove" %}}
{{% /pic %}}
...
{{% pic src="map-poonhill.png" alt="Map of the pre-dawn loop up Poon Hill and back" %}}
The pre-dawn loop up Poon Hill and back. 1.5 miles, 950 ft up, 950 ft down, 2h 31m.
{{% /pic %}}

{{% pic src="IMG_6519.jpg" alt="Sunrise over the Annapurnas from Poon Hill" %}}
Poon Hill at dawn.
{{% /pic %}}

{{% pic src="IMG_6528.jpg" alt="The Annapurnas from Poon Hill" %}}
...
{{% pic src="IMG_6548.jpg" alt="Ghorepani village" %}}
Ghorepani.
{{% /pic %}}

{{% pic src="map-ghorepani-tadapani.png" alt="Map of the trek from Ghorepani to Tadapani" %}}
...
{{% pic src="IMG_6556.jpg" alt="Rhododendron forest on the trail to Tadapani" %}}
{{% /pic %}}

{{% pic src="IMG_6558.jpg" alt="Rhododendron forest" / %}}

{{% pic src="IMG_6598.jpg" alt="Rhododendron forest" / %}}

{{% pic src="IMG_6619.jpg" alt="Rhododendron forest" / %}}

{{% pic src="IMG_6575.jpg" alt="A water buffalo on the trail" %}}
A water buffalo.
{{% /pic %}}

<video controls style="width: 100%; margin-bottom: 1em">
  <source src="IMG_6567.mp4" type="video/mp4">
</video>
...
{{% pic src="IMG_6583.jpg" alt="A can of Nepali Red Bull" %}}
Nepali Red Bull---a welcome jolt on the trail.
{{% /pic %}}


There were practically no temples or shrines out here---the country folk are either less religious than in Kathmandu or just too poor to build anything more than their home altars. We sometimes passed cairns, [mani stones](https://en.wikipedia.org/wiki/Mani_stone), sticks, and prayer flags.

<video controls style="width: 100%; margin-bottom: 1em">
  <source src="IMG_6628.mp4" type="video/mp4">
</video>

{{% pic src="IMG_6565.jpg" alt="A stupa on the trail" %}}
{{% /pic %}}

{{% pic src="IMG_6584.jpg" alt="A stupa on the trail" / %}}

{{% pic src="IMG_6587.jpg" alt="Rhododendron forest" / %}}

We walked steeply downhill along a creek and a series of seeps and cascades.

<video controls style="width: 100%; margin-bottom: 1em">
  <source src="IMG_6605.mp4" type="video/mp4">
</video>

<video controls style="width: 100%; margin-bottom: 1em">
  <source src="IMG_6607.mp4" type="video/mp4">
</video>
...
{{% pic src="map-tadapani-ghandruk.png" alt="Map of the trek from Tadapani to Ghandruk" %}}
Tadapani to Ghandruk. 3.7 miles, 50 ft up, 2,050 ft down, 2h 54m.
{{% /pic %}}

{{% pic src="IMG_6651.jpg" alt="The trail to Ghandruk" %}}
The trail to Ghandruk.
{{% /pic %}}

We reached a comparatively nice multistory hotel in Ghandruk before the inevitable afternoon rain. We each had a flush toilet and hot shower _en suite_, with a towel provided, a day earlier than I expected! In the evening we watched the peaks appear and disappear as storms passed, until a busload of shouting Bengali tourists arrived and broke the quiet.

{{% pic src="IMG_6678.jpg" alt="Ghandruk village" %}}
Ghandruk.
{{% /pic %}}
...
{{% pic src="IMG_6691.jpg" alt="Ghandruk at dawn" / %}}

{{% pic src="IMG_6697.jpg" alt="Ghandruk at dawn" / %}}

{{% pic src="IMG_6701.jpg" alt="Ghandruk at dawn" / %}}

<video controls style="width: 100%; margin-bottom: 1em">
  <source src="IMG_6716.mp4" type="video/mp4">
</video>

{{% pic src="IMG_6717.jpg" alt="Ghandruk" / %}}

After breakfast we walked downhill, 3.5 miles horizontally and nearly half a mile vertically, mostly on stone steps. There were _miles_ of stone steps: I can't believe the effort these people expend building them. We were traveling on their work of art. The variety of stone colors and textures was a pleasure to watch passing beneath my feet.

{{% pic src="map-ghandruk-kilu.png" alt="Map of the descent from Ghandruk to Kilu" %}}
...
{{% pic src="IMG_6740.jpg" alt="Terraced farmland on the descent to Kilu" %}}
{{% /pic %}}

{{% pic src="IMG_6751.jpg" alt="Terraced farmland" / %}}

{{% pic src="IMG_6774.jpg" alt="Terraced farmland" / %}}

{{% pic src="IMG_6782.jpg" alt="Terraced farmland" / %}}
...
<video controls style="width: 100%; margin-bottom: 0.5em">
  <source src="IMG_6743.mp4" type="video/mp4">
</video>
...
{{% pic src="IMG_6805.jpg" alt="The junior abbot at Pema Ts'al Sakya Monastic Institute" %}}
...
Use [Lonely Planet Journeys](https://www.elsewhere.io/) to book your trip while you're still at home, or use [Aarya Village travel agency](https://www.aaryatravel.com/) directly. They will arrange intra-Nepal air travel, cars, guides, hotels, and so on. Start booking far in advance; if you're in the US then the timezone difference means you can exchange only one pair of emails a day.

[I found a helpful trip report and packing list on this blog](https://stingynomads.com/ghorepani-poon-hill-trek-itinerary/).
...
* [LifeStraw bottle](https://lifestraw.com/products/lifestraw-go-series-1l) as a convenient supplement to the bladder and tabs.
