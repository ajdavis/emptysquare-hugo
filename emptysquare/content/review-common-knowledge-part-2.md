...
Can we do the same for Raft? The real Raft TLA+ spec has dozens of variables. Let's simplify. Let's say there's one log entry, there's a permanent leader, and there is a set *F* of two followers named _f_<sub>1</sub> and _f_<sub>2</sub>. Here are our variables:
