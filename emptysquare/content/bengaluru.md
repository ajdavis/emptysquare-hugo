...
date = "2026-06-08T12:12:40.507518+00:00"
description = "Trip report of a week in India's tech capital."
draft = false
...
{{% pic src="bengaluru-01.jpg" alt="A hotel bathroom with marble floors and walls, a glass shower, and a bathtub" %}}
Marblemaxxing.
{{% /pic %}}
{{% pic src="bengaluru-02.jpg" alt="Close-up of worn gray hiking pants with a tear neatly sewn up" %}}
...
{{% pic src="bengaluru-03.jpg" alt="A green park sign with a cobra graphic, warning that snakes lurk in bushes, holes, and Lucullus" %}}
{{% /pic %}}
...
{{% pic src="bengaluru-04.jpg" alt="Rows of carved stone naga statues on a platform beside a small shrine" %}}
{{% /pic %}}
...
{{% pic src="bengaluru-06.jpg" alt="A small temple built against a sheer granite cliff" %}}
{{% /pic %}}
{{% pic src="bengaluru-07.jpg" alt="A green metal machine holding a ritual drum and a cage of brass bells" %}}
{{% /pic %}}

{{% pic src="bengaluru-05.jpg" alt="A bronze statue of a seated figure embracing a sapling, its limbs inscribed with text" %}}
A modern statue embracing a sapling.
{{% /pic %}}
{{% pic src="bengaluru-08.jpg" alt="A stepped stone temple tank with bougainvillea cascading over the far wall" %}}
A stepped temple tank on Nandi Hills, bougainvillea spilling over the far wall.
{{% /pic %}}
{{% pic src="bengaluru-09.jpg" alt="Glass-roofed metal viewing platforms built among tall trees" %}}
Cool platforms and glass pavilions built around trees. I don't know their purpose.
{{% /pic %}}
{{% pic src="bengaluru-10.jpg" alt="Interior of a ruined stone watchtower, its graffiti-covered arched windows framing the plains below" %}}
A watchtower.
{{% /pic %}}
...
{{% pic src="bengaluru-12.jpg" alt="A yali, a mythical lion, carved into the smooth granite at the hilltop, with a temple beyond" %}}
{{% /pic %}}
{{% pic src="bengaluru-11.jpg" alt="Steps cut into the smooth granite slope near the summit, worn by centuries of feet" %}}
{{% /pic %}}
...
{{% pic src="bengaluru-13.jpg" alt="A collapsed lattice tower and a toppled white microwave dish on the hilltop" %}}
Ruins of a microwave transmission tower.
{{% /pic %}}
{{% pic src="bengaluru-14.jpg" alt="Rusted communications equipment bolted to a pole, the plains stretching out beyond" %}}
More ruined communications gear.
{{% /pic %}}
{{% pic src="bengaluru-15.jpg" alt="Laundry strung up to dry across a stone temple courtyard on the hilltop" %}}
Courtyard of the Yoga Nandeeshwara Temple.
{{% /pic %}}
{{% pic src="bengaluru-16.jpg" alt="A monkey walking the roof of a whitewashed building, above a police notice forbidding climbing" %}}
A monkey flouting the rules, as usual.
{{% /pic %}}
{{% pic src="bengaluru-17.jpg" alt="A small stone temple hewn from the rock, framed by gnarled tree branches" %}}
{{% /pic %}}
{{% pic src="bengaluru-18.jpg" alt="A view from the hills over green slopes and red farmland, with a conical peak in the distance" %}}
{{% /pic %}}
{{% pic src="bengaluru-19.jpg" alt="A sunny view of patchwork farmland on the plains far below the summit" %}}
{{% /pic %}}
{{% pic src="bengaluru-21.jpg" alt="A stone-walled viewpoint at the cliff's edge, overlooking the plains" %}}
{{% /pic %}}
...
{{% pic src="bengaluru-20.jpg" alt="A selfie of me with red and yellow tilak marks on my forehead, the plains behind" %}}
{{% /pic %}}
...
{{% pic src="bengaluru-22.jpg" alt="Visitors crossing a vast plaza toward the giant Adiyogi Shiva head in the distance" %}}
{{% /pic %}}
...
{{% pic src="bengaluru-26.jpg" alt="A quarry of white stone with a green pond at its base, beside the road to Bangalore" %}}
{{% /pic %}}
