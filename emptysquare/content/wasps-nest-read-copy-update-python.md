...
<p><strong>Update:</strong> In this post's first version I didn't know how close my code is to "ready-copy-update". <a href="/wasps-nest-read-copy-update-python/#comment-890288132">Robert Moore schooled me</a> in the comments. I also named it "a lock-free concurrency pattern" and <a href="/wasps-nest-read-copy-update-python/#comment-892664861">Steve Baptiste pointed out</a> that I was using the term wrong. My algorithm merely solves a race condition without adding a mutex, it's not lock-free. I love this about blogging: in exchange for a little humility I get a serious education.</p>
<hr />
<ul>
