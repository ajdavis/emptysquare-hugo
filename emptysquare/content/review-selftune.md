...
Humans still have to think and experiment to choose the "radius" and "learning rate" hyperparameters. I wish they had discussed the method for this, it seems important but not automatic. BlueFin is so simple, I wonder whether it risks getting stuck in a suboptimal local maximum, or conversely whether it risks jumping around forever and **missing** the maximum. SelfTune's learning method is pluggable, and I wonder if it would perform better with a more sophisticated method than BlueFin.
